...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, STEP1_EN_Pin|Led_W_Pin|Relay_6_Pin|Relay_5_Pin
  ...
  /*Configure GPIO pins : INP4_Pin INP3_Pin INP2_Pin INP1_Pin
                           CT_ACC_Pin CT_Break_Pin */
  GPIO_InitStruct.Pin = INP4_Pin|INP3_Pin|INP2_Pin|INP1_Pin
                          |CT_ACC_Pin|CT_Break_Pin;
  ...
  /*Configure GPIO pins : Led_W_Pin Relay_6_Pin Relay_5_Pin Relay_4_Pin
                           Relay_3_Pin Relay_2_Pin Relay_1_Pin */
  GPIO_InitStruct.Pin = Led_W_Pin|Relay_6_Pin|Relay_5_Pin|Relay_4_Pin
                          |Relay_3_Pin|Relay_2_Pin|Relay_1_Pin;
  ...
  /*Configure GPIO pins : Buzz_Pin DIR3_UART3_Pin */
  GPIO_InitStruct.Pin = Buzz_Pin|DIR3_UART3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
