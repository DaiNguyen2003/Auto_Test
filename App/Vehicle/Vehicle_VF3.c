...
Car_Define_Typedef Vinfast_VF3 = {
	...
	.Defined_CAN_Msg = {
	    /* ================= BRAKE ================= */
	    {
	        .name = Brake_Msg, .id = 0x269, .port = CAN_MSG_PORT_1, .dlc = 8, .sig_num = 1,
	        .Signal = {
	            { .name = SIG_BRAKE_SWITCH_STS, .factor = 1.0f, .offset = 0.0f, .start_bit = 29, .length = 2, .is_signed = 0, .endian = CAN_MOTOROLA }
	        }
	    },
	    {
	        .name = Brake_Msg, .id = 0x102, .port = CAN_MSG_PORT_1, .dlc = 8, .sig_num = 1,
	        .Signal = {
	    ...
	    /* ================= LV ================= */
	    {
	        .name = LV_Msg, .id = 0x10A, .port = CAN_MSG_PORT_1, .dlc = 8, .sig_num = 1,
	        .Signal = {
