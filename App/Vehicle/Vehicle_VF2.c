...
Car_Define_Typedef Vinfast_VF2 = {
	...
	.Defined_CAN_Msg = {
	    ...
	    /* ================= KEY ================= */
	    {
	        .name = Key_Msg, .id = 0x201, .dlc = 8, .sig_num = 2,
	        .Signal = {
	    ...
	    /* ================= GEAR ================= */
	    {
	        .name = Gear_Msg, .id = 0x155, .dlc = 8, .sig_num = 1,
	        .Signal = {
	    ...
	    /* ================= LV ================= */
	    {
	        .name = LV_Msg, .id = 0x201, .dlc = 8, .sig_num = 1,
	        .Signal = {
